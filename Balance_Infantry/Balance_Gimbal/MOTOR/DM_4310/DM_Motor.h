...
/******************* 结构体or变量的声明 **********/
extern DM_Motor_t Yaw_DM4310;
/************************************************/


/****************** 函 数 声 明 ********************************/
void DM_Motor_Information_Send(CAN_TypeDef* CANx,uint16_t CAN_ID,float P_des,float V_ref,float T_ref,float Kp,float Kd);	//信息发送
