...
void CAN1_Send_Task_1(float Joint_T_Set1,float Joint_T_Set4)
{
    ...
    {
        DaMiao_8009_Enable(CAN1,JOINT1_CONTROL_ID);
    }
    ...
    {
        DaMiao_8009_Clear_Error_Information(CAN1,JOINT1_CONTROL_ID);
    }
    ...
    {
        DaMiao_8009_Enable(CAN1,JOINT4_CONTROL_ID);
    }
    ...
    {
        DaMiao_8009_Clear_Error_Information(CAN1,JOINT4_CONTROL_ID);
    }
    while((CAN1->TSR & (CAN_TSR_TME0 | CAN_TSR_TME1 | CAN_TSR_TME2)) == 0);//等待有发送邮箱空
}
...
void CAN1_Send_Task_2(float Joint_T_Set2, float Joint_T_Set3)
{
    ...
    {
          DaMiao_8009_Enable(CAN1,JOINT3_CONTROL_ID);
    }
    ...
    {
        DaMiao_8009_Clear_Error_Information(CAN1,JOINT3_CONTROL_ID);
    }
    while((CAN1->TSR & (CAN_TSR_TME0 | CAN_TSR_TME1 | CAN_TSR_TME2)) == 0);//等待有发送邮箱空
    
    if(Joint_Motor[1].ERR == DM_DISABLE)
    {
          DaMiao_8009_Enable(CAN1,JOINT2_CONTROL_ID);
    }
    ...
    {
        DaMiao_8009_Clear_Error_Information(CAN1,JOINT2_CONTROL_ID);
    }
    while((CAN1->TSR & (CAN_TSR_TME0 | CAN_TSR_TME1 | CAN_TSR_TME2)) == 0);//等待有发送邮箱空
