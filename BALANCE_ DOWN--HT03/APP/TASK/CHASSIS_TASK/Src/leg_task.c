             ...
             float spd[2])
{
  ...
  t52 = 1.0 / (t38 + t42);
  t53 = t52 * t52;
  t59 = sqrtf((t34 * t34 + t38 * t38) - t42 * t42);
  t60 = 1.0 / t59;
  t30 = (t24 - t23) + t59;
  t28 = atanf(t52 * t30) * 2.0;
  t70 = cosf(t28);
  t71 = sinf(t28);
  t76 = 1.0 / (t53 * (t30 * t30) + 1.0);
  t47 = (t23 + t47) * t53 * t30 +
        t52 * (t21 -
               t60 * ((t2 * t34 * 0.162 + t4 * t38 * 0.162) - t42 * t47 * 2.0) /
                   2.0);
  t28 = (t24 + t48) * t53 * t30 +
        t52 * (t22 -
               t60 * ((t3 * t34 * 0.162 + t5 * t38 * 0.162) - t42 * t48 * 2.0) /
                   2.0);
  t4 = t12_tmp + t71 * 0.27;
  t21 = (t10_tmp + t70 * 0.27) - 0.075;
  t59 = t70 * t76;
  t23 = t59 * t28;
  t53 = t71 * t76;
  t2 = t53 * t28;
  t28 = (-t10_tmp - t70 * 0.27) + 0.075;
  t60 = t28 * t28;
  t52 = 1.0 / t28;
  t30 = t4 * t4;
  t28 = 1.0 / sqrtf(t30 + t21 * t21);
  t48 = 1.0 / (t30 + t60);
  t59 = t10_tmp - t59 * t47 * 0.54;
  t30 = t12_tmp - t53 * t47 * 0.54;
  spd[0] = dphi4 * t28 * (t4 * t23 * 1.08 - t21 * t2 * 1.08) / 2.0 +
           dphi1 * t28 * (t4 * t59 * 2.0 - t21 * t30 * 2.0) / 2.0;
  t28 = t4 * (1.0 / t60);
  spd[1] = -dphi1 * t60 * t48 * (t52 * t59 - t28 * t30) +
           dphi4 * t60 * t48 * (t52 * (0.0 - t23 * 0.54) + t28 * (t2 * 0.54));
}
/*
...
void leg_conv(float F, float Tp, float phi1, float phi4, float T[2])
{
  ...
  t104 = sqrtf((t56_tmp * t56_tmp + t66_tmp * t66_tmp) - t73_tmp * t73_tmp);
  t106_tmp = 1.0 / t104;
  t108_tmp = (t36_tmp - t35_tmp) + t104;
  t120_tmp = atanf(t51_tmp * t108_tmp) * 2.0;
  ...
  t108_tmp = F * (1.0 / sqrtf(t104 + t81_tmp * t81_tmp));
...
void leg_J_cal(float phi1, float phi4, float J[4])
{
  ...
  t28 = (t24 + t48) * t53 * t30 +
        t52 * (t22 -
               t60 * ((t3 * t34 * 0.162 + t5 * t38 * 0.162) - t42 * t48 * 2.0) /
                   2.0);
  t21 = t12_tmp + t71 * 0.27;
  t23 = (t10_tmp + t70 * 0.27) - 0.075;
  t59 = t70 * t76;
  t47 = t59 * t28;
  t60 = t71 * t76;
  t4 = t60 * t28;
  ...
  t52 = 1.0 / t28;
  t30 = t21 * t21;
  t53 = 1.0 / sqrtf(t30 + t23 * t23);
  t48 = 1.0 / (t30 + t2);
  t59 = t10_tmp - t59 * t106 * 0.54;
  t28 = t12_tmp - t60 * t106 * 0.54;
  J[0] = t53 * (t21 * t59 * 2.0 - t23 * t28 * 2.0) / 2.0;
  t30 = t21 * (1.0 / t2);
  J[1] = -t2 * t48 * (t52 * t59 - t30 * t28);
  J[2] = t53 * (t21 * t47 * 1.08 - t23 * t4 * 1.08) / 2.0;
  J[3] = t2 * t48 * (t52 * (0.0 - t47 * 0.54) + t30 * (t4 * 0.54));
}
