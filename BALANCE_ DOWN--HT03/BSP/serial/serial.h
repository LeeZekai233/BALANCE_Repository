...
#define USART2_Data_Receive_Process_0				do{SuperCap_message_Process(&usart_capacitance_message,usart2.RX_BUFF);}while(0);
#define USART2_Data_Receive_Process_1				do{}while(0);
	
#define USART3_Data_Receive_Process_0				do{TF02_DataProgress(usart3.RX_BUFF,&mea_distance);}while(0);
...
#define UART5_Data_Receive_Process_0				do{usart_chassis_receive(usart5.RX_BUFF);}while(0);
#define UART5_Data_Receive_Process_1				do{}while(0);

#define USART6_Data_Receive_Process_0				do{CH100_getDATA(usart6.RX_BUFF,&chassis_gyro,0,0,0,0,0,0,0,0);}while(0);
