...
#define CHASSIS_RAMP_X_STEP_SIZE									0.007
#define CHASSIS_RAMP_Y_STEP_SIZE									0.007
...
typedef struct
{
		...
		float	       cos_chassis_angle;	//底盘和云台之间的夹角的正余弦值
...
//		int16_t		   left_right_to_left_right_rotate_speed;
        ...
        float Speed_Ref[4];//速度参考值
	    float Speed_Fdb[4];//速度反馈值
//        float Power_Limit[4];
//	    float Power_Limit_By_Current_k[4];
