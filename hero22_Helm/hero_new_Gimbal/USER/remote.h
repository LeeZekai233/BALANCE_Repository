...
#define MOUSE_TO_PITCH_ANGLE_INC_FACT 		0.0035f
#define MOUSE_TO_YAW_ANGLE_INC_FACT 		0.0026f
...
extern uint8_t remote_lost_flag;
extern uint8_t trigger1_flag;
extern uint8_t trigger2_flag;
extern uint16_t trigger2_cnt,trigger1_cnt;
extern Key_Flag_t Key_Flag;
extern uint8_t Auto_Shoot_Fire;
#endif
