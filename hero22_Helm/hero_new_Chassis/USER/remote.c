...
//		return;
    ...
    SetInputMode(&RC_CtrlData);//看使用哪个遥控器进行切换,若用白控,这个注释解开
...
//    
//    
//    if(RC_CtrlData.rc.s1 != 2 &&RC_CtrlData.rc.s2==1)//左上拨杆不在下方时拨轮控制发射机构
//	{
//		if(trigger2_flag == 1)
//		{
//			_42mm_shoot.friction_state = FRICTION_ON;
//	//		if(_42mm_shoot.poke_state!=POKE_TRAP)
...
//			//_42mm_shoot.poke_state = POKE_RELAX;
...
////		}
//	}
//	else if(RC_CtrlData.rc.s1 == 2&&RC_CtrlData.rc.s2==1)//左上拨杆在下方时拨轮控制小陀螺方向
//	{
