...
//    NVIC_Init(&nvic);    
    ...
    CAN_Init(CAN1, &can);
//u16 sid1=0x310,sid2=0x304,sid3=0x200,sid=0x306;
...
//		can_filter.CAN_FilterIdHigh=sid1<<5;
//		can_filter.CAN_FilterIdLow=sid2<<5;
//		can_filter.CAN_FilterMaskIdHigh=sid3<<5;
//		can_filter.CAN_FilterMaskIdLow=sid4<<5;
...
void CAN1_Send(int num1,int num2,int num3,int num4,int num5)
{
	CanTxMsg TX;
	...
	TX.RTR=CAN_RTR_Data;
	TX.Data[0]  =  (uint8_t)((num1)>>8);
	TX.Data[1]  =  (uint8_t)(num1);
	TX.Data[2]  =  (uint8_t)((num2)>>8);
	TX.Data[3]  =  (uint8_t)(num2);
	TX.Data[4]  =  (uint8_t)((num3)>>8);
	TX.Data[5]  =  (uint8_t)(num3);
	TX.Data[6]  =  (uint8_t)(num4);
	TX.Data[7]  =  (uint8_t)(num5);
