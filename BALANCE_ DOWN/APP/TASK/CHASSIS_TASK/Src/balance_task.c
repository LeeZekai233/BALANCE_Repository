...
void balance_chassis_task(void)
{
    ...
    b_chassis.min_speed = -1.5;
		...
		pre_power = all_power_cal(balance_chassis.Driving_Encoder[0].Torque,-2.528,0.000494,1,balance_chassis.Driving_Encoder[0].rate_rpm) + all_power_cal(balance_chassis.Driving_Encoder[1].Torque,-2.528,0.000494,1,balance_chassis.Driving_Encoder[1].rate_rpm);
		if(pre_power<0)
			pre_power = 0;
#endif 
}
...
//		K[0] = ((L0 * -165.99816801304181 + t2 * 291.43658730022639) -
//          t3 * 211.8819446449379) -
//         0.28500051993080622;
//  K[1] = ((L0 * 44.883879777371433 - t2 * 311.34514734999442) +
//          t3 * 344.5261879633378) +
//         33.270754740011078;
//  K[2] = ((L0 * -12.241974925758329 - t2 * 1.816285741551054) +
//          t3 * 4.2921658989923834) +
//         0.36749319376012768;
//  K[3] = ((L0 * 24.018611105740629 - t2 * 62.542810665748107) +
//          t3 * 52.962948173936176) +
//         1.05380624758371;
//  K[4] = ((L0 * -2.1092551368656891 + t2 * 4.8759763189496184) -
//          t3 * 3.9291372755304752) +
//         0.0329643020757118;
//  K[5] = ((L0 * -3.23636468035095 + t2 * 3.6268356293615591) -
//          t3 * 1.1104845133079639) +
//         1.1244119397473871;
//  K[6] = ((L0 * -34.242406110399457 + t2 * 78.8276520120072) -
//          t3 * 63.468890590649217) +
//         0.517471639449362;
//  K[7] = ((L0 * -52.948206230040377 + t2 * 60.19264103430973) -
//          t3 * 19.333093653658391) +
//         18.328602743677351;
//  K[8] = ((L0 * -80.01543822262532 + t2 * 98.4839831118011) -
//          t3 * 39.074363534052033) +
//         26.597643652759231;
//  K[9] = ((L0 * 445.44419672349733 - t2 * 1032.664420607286) +
//          t3 * 832.59635031388029) -
//         1.914510737952186;
//  K[10] = ((L0 * -9.6190322322057416 + t2 * 11.62750166300258) -
//           t3 * 4.8097698114396934) +
//          3.4752573596073049;
//  K[11] = ((L0 * 52.228092339164881 - t2 * 118.13968909487809) +
//           t3 * 93.708999998204987) -
//          2.5022891608939268;
